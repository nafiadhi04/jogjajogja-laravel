...
class PenginapanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Simpan thumbnail dan dapatkan path lengkapnya
        ...
        if ($request->hasFile('gambar')) {
            foreach ($request->file('gambar') as $file) {
                // Simpan gambar galeri dan dapatkan path lengkapnya
    ...
    public function update(Request $request, Penginapan $penginapan)
    {
        ...
        if ($request->hasFile('thumbnail')) {
            ...
            if ($penginapan->thumbnail && Storage::disk('public')->exists($penginapan->thumbnail)) {
        ...
        if ($request->hasFile('gambar')) {
            // Hapus semua gambar galeri lama dari storage dan database
    ...
    public function destroy(Penginapan $penginapan)
    {
        ...
        // Hapus semua gambar galeri terkait dari storage
        foreach ($penginapan->gambar as $gambar) {
            if (Storage::disk('public')->exists($gambar->path_gambar)) {
                Storage::disk('public')->delete($gambar->path_gambar);
            }
        ...
        // Hapus entri penginapan dan relasi dari database
