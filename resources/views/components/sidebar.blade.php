...
<aside :class="open ? 'w-64' : 'w-20'"
    ...
    <nav class="flex-1 mt-4 space-y-2">
        ...
        {{-- Tautan yang bisa dilihat SEMUA user (admin & member) --}}
        ...
        {{-- Tautan yang HANYA bisa dilihat oleh ADMIN --}}
        ...
        {{-- Tautan "Kelola Penginapan" sekarang bisa dilihat SEMUA user (admin & member) --}}
        <a href="{{ route('admin.penginapan.index') }}"
            class="flex items-center px-6 py-3 space-x-4 hover:bg-gray-700 {{ request()->routeIs(['admin.penginapan.index', 'admin.penginapan.create', 'admin.penginapan.edit']) ? 'bg-gray-700' : '' }}"
