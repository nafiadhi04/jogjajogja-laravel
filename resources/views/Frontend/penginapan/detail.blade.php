...
@media (min-width: 1000px) {
    ...
    <div class="pt-24 pb-8 bg-gray-50">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            {{-- Header Penginapan --}}
            <div class="mb-6">
                <h1 class="text-3xl md:text-4xl font-extrabold tracking-tight text-gray-900">{{ $penginapan->nama }}</h1>
                <div class="flex flex-wrap items-center gap-x-6 gap-y-2 mt-2"> {{-- Membungkus harga dan info --}}
