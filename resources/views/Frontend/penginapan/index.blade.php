                ...
                <div class="mt-4 md:mt-0">
                    <form method="GET" action="{{ route('penginapan.list') }}" class="flex items-center space-x-4">
                        ...
                        <select name="sort_by" onchange="this.form.submit()" 
                                class="px-4 py-2 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500">
                                        ...
                                        <div class="overflow-hidden transition-shadow duration-300 bg-white shadow-lg rounded-2xl hover:shadow-xl group">
                                            ...
                                            <div class="relative overflow-hidden">
                                                <a href="{{ route('penginapan.detail', $item->slug) }}">
                                                    {{-- Memeriksa apakah properti 'thumbnail' ada dan tidak kosong --}}
                                                    @if($item->thumbnail)
                                                        {{-- Menggunakan 'storage/' diikuti dengan path dari database ($item->thumbnail) --}}
                                                    ...
                                                    @else
                                                        {{-- Tampilan fallback jika tidak ada thumbnail --}}
