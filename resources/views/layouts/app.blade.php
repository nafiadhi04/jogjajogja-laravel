    ...
    <div class="flex flex-col flex-1 min-w-0 overflow-hidden">
        <div class="flex flex-col flex-1">
            <main class="flex-1 overflow-y-auto bg-">
                ...
                {{-- ========================================================== --}}
                {{-- PERBAIKAN UTAMA: Header Konten dengan Tombol Toggle --}}
                {{-- ========================================================== --}}
                <div class="flex items-center justify-between p-1 border-b h-14 border-slate-700 bg-slate-800">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6 ">
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <button
                                    class="inline-flex items-center px-3 py-2 text-sm font-medium leading-4 text-gray-500 transition duration-150 ease-in-out border border-transparent rounded-md bg-slate-800 hover:text-gray-700 focus:outline-none">
