                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full text-sm border border-gray-200 table-fixed">
                        ...
                        <tbody>
                            @forelse($users as $index => $user)
                                                                                            ...
                                                                                            <td class="px-3 py-2 align-top border">
                                                                                                <div class="flex items-center gap-3">
                                                                                                    <img src="{{ $user->profile_photo_path ? asset('storage/' . $user->profile_photo_path) : 'https://ui-avatars.com/api/?name=' . urlencode($user->name) . '&color=7F9CF5&background=EBF4FF' }}"
                                                                                                        alt="{{ $user->name }}"
                                                                                                        class="object-cover w-8 h-8 rounded-full ring-1 ring-slate-200">
                                                                                                    <div class="min-w-0">
                                                                                                        <div class="text-sm font-medium text-gray-800 truncate">{{ $user->name }}
                                                                                                        </div>
                                ...
                                $roleClass = match ($user->role) {
                                    ...
                                    default => 'bg-green-100 text-green-800',
                                                                                                ...
                                                                                                @else
                                                                                                    <span
                                                                                                        class="inline-block px-2 py-0.5 text-xs font-semibold rounded-full {{ $roleClass }}">
                                                                                                        {{ ucfirst($user->role) }}
                                                                                                    </span>
                                                                                                @endcan
                                                                                            </td>
                                                                        ...
                                                                        <button x-ref="btn" @click="openMenu()" type="button"
                                                                            ...
                                                                            <span>Pilihan</span>
                                                                                                ...
                                                                                                @can('admin')
                                                                                                    <div x-show="roleModalOpen" x-cloak
                                                                                                        class="fixed inset-0 z-50 flex items-center justify-center p-4">
                                                                                                        <div x-show="roleModalOpen" x-transition
                                                                                                        ...
                                                                                                        <div x-show="roleModalOpen" x-transition @click.outside="roleModalOpen = false"
                                                                                                            ...
                                                                                                            <form action="{{ route('admin.users.update', $user) }}" method="POST"
                                                                                                                ...
                                                                                                                @method('PUT')
                                                                                                                <div class="p-6">
                                                                                                                    <h3 class="text-lg font-semibold text-gray-900">Ubah Peran untuk:
                                                                                                                        {{ $user->name }}</h3>
                                                                                                                    <input type="hidden" name="name" value="{{ $user->name }}">
                                                                                                                    <input type="hidden" name="email" value="{{ $user->email }}">
                                                                                                                    <div class="mt-4">
                                                                                                                        <label for="role_{{ $user->id }}"
                                                                                                                            class="block text-sm font-medium text-gray-700">Peran
                                                                                                                            Baru</label>
                                                                                                                        <select name="role" id="role_{{ $user->id }}"
                                                                                                                            class="block w-full mt-1 text-sm border-gray-300 rounded">
                                                                                                                            <option value="pending" @selected($user->role == 'pending')>
                                                                                                                                Pending</option>
                                                                                                                            <option value="silver" @selected($user->role == 'silver')>
                                                                                                                                Silver</option>
                                                                                                                            <option value="gold" @selected($user->role == 'gold')>Gold
                                                                                                                            </option>
                                                                                                                            <option value="platinum" @selected($user->role == 'platinum')>
                                                                                                                                Platinum</option>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-3 py-8 text-center text-gray-500 border">Tidak ada data user
                                        yang cocok.</td>
                                </tr>
                            @endforelse
                        </tbody>
