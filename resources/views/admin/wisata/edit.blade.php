                    ...
                    {{-- Lokasi Google Maps --}}
                                        <div class="grid grid-cols-1 gap-6 pt-6 mt-6 border-t md:grid-cols-2">
                                            <div>
                                                ...
                                                <input type="text" name="latitude" id="latitude" value="{{ old('latitude', $wisata->latitude) }}"
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="longitude" id="longitude" value="{{ old('longitude', $wisata->longitude) }}"
                                                    class="block w-full mt-1 border-gray-300 rounded-md shadow-sm" placeholder="">
                                            </div>
                                        </div>
                    <div>
