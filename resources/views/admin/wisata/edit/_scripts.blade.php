{{-- resources/views/admin/wisata/edit/_scripts.blade.php --}}
@push('scripts')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            form.addEventListener('submit', function (e) {
                if (quill.root.innerHTML === '<p><br></p>') deskripsiInput.value = '';
                else deskripsiInput.value = quill.root.innerHTML;
            });

            // Quill image upload helper
            function selectLocalImage() {
                ...
                input.onchange = () => {
                    ...
                    else alert('Anda hanya bisa mengupload file gambar.');
                };
            }
            ...
            function saveToServer(file) {
                ...
                fetch("{{ route('admin.wisata.upload.image') }}", {
                    ...
                    .then(response => response.json())
                    .then(result => {
                        if (result.url) insertToEditor(result.url);
                        else alert('Upload gagal: ' + (result.message || 'Error tidak diketahui'));
                    })
                    .catch(error => {
