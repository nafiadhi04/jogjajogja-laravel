{{-- resources/views/admin/wisata/edit/_form.blade.php --}}
    ...
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="p-4 overflow-hidden bg-white rounded-lg shadow">
            ...
            <form action="{{ route('admin.wisata.update', $wisata) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                    ...
                    <div>
                        ...
                        <select name="kota" id="kota" required
                            class="block w-full mt-1 text-sm border-gray-300 rounded shadow-sm">
                            <option value="Yogyakarta" @selected(old('kota', $wisata->kota) == 'Yogyakarta')>Yogyakarta
                            </option>
                            ...
                            <option value="Gunungkidul" @selected(old('kota', $wisata->kota) == 'Gunungkidul')>Gunungkidul
                            </option>
                            <option value="Kulon Progo" @selected(old('kota', $wisata->kota) == 'Kulon Progo')>Kulon Progo
                            </option>
                        </select>
                    </div>
                </div>
                ...
                {{-- Harga Tiket --}}
                <div>
                    <label for="harga_tiket" class="block text-xs font-medium text-gray-700">Harga Tiket (Rp)</label>
                            ...
                            <div class="flex items-start">
                                <div class="flex items-center h-4">
                                    <input id="fasilitas-{{ $item->id }}" name="fasilitas[]" value="{{ $item->id }}"
                                        ...
                                        @if(is_array($checkedFasilitas) && in_array($item->id, $checkedFasilitas)) checked
                                        @endif>
                                </div>
