<x-app-layout>
    ...
    {{-- Tampilan dibuat lebih compact tanpa mengubah field --}}
    {{-- ========================================================== --}}
        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="p-4 overflow-hidden bg-white rounded-lg shadow">
                ...
                <form action="{{ route('admin.penginapan.update', $penginapan) }}" method="POST"
                    enctype="multipart/form-data" class="space-y-4" @submit="prepareFormSubmit">
                    @csrf
                    @method('PUT')

                    {{-- Field atas: 3 kolom compact --}}
    ...
    @push('scripts')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                var quill = new Quill('#editor-container', {
                    ...
                    modules: {
                        toolbar: [
                            ...
                            [{ 'align': [] }],
                            ['link', 'image'], // Tombol image ini akan kita override
                            ['clean']
                        ]
                    }
                });
                ...
                // Meng-override handler tombol 'image' pada toolbar Quill
