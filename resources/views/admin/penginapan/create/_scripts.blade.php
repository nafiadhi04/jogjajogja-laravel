{{-- resources/views/admin/penginapan/create/_scripts.blade.php --}}
@push('scripts')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (deskripsiInput) deskripsiInput.value = quill.root.innerHTML;
            ...
            // image upload handler used by quill image button
            ...
            async function saveToServer(file) {
                ...
                try {
                    const res = await fetch("{{ route('admin.penginapan.upload.image') }}", {
                        method: 'POST',
                        headers: {
